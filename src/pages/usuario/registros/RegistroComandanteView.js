...
export const RegistroComandanteView = () => {
    ...
    const [refresh] = useSetFetchData("/persona/primerjefe", adapterFecha)

    const handlerSubmitData = async (e) => {
        e.preventDefault()
        const [, ok, message] = await fetchPostData("/persona/primerjefe", {
            ...comandante,
        ...
        setEdit(false)
        //TODO console.log(comandante) mandar datos TODO
    }
    return (
        <div className="container mb-4">
            <p className="h5 ms-3 mt-4 mb-4">Datos del comandante</p>
